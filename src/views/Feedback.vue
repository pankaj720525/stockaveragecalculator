...
const sitekey = import.meta.env.VITE_HCAPTCHA_KEY;  // ✅ CORRECT
  ...
  <div class="max-w-xl mx-auto bg-white dark:bg-gray-800 p-6 shadow-md rounded-lg">
    ...
    <form @submit.prevent="submitFeedback">
      ...
      <div class="mb-4">
        ...
        <input v-model="form.name" type="text" class="w-full p-2 border rounded dark:bg-gray-900 dark:text-white"
          required />
      </div>
      ...
      <div class="mb-4">
        ...
        <input v-model="form.email" type="email" class="w-full p-2 border rounded dark:bg-gray-900 dark:text-white"
          required />
      </div>
      ...
      <div class="mb-4">
        ...
        <textarea v-model="form.description" class="w-full p-2 border rounded h-28 dark:text-white dark:bg-gray-900"
      ...
      <!-- hCaptcha -->
      <div class="mb-4">
        <h-captcha :sitekey="sitekey" @verify="onCaptchaVerified">
        </h-captcha>
      </div>

      <!-- Submit Button -->
      <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded" :disabled="!captchaToken">
        Submit
      </button>
    </form>
