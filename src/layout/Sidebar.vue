    ...
    <div class="fixed inset-y-0 left-0 bg-white dark:bg-gray-800 border-r transition-transform duration-300 transform md:w-[250px] md:translate-x-0"
     :class="showSide ? 'translate-x-0 w-[250px] z-20' : '-translate-x-full'">
          ...
          <ul class="p-4 space-y-2">
              <li>
                <router-link to="/home" class="inline-flex relative items-center py-[10px] w-full rounded-md px-[10px] hover:bg-gray-700 hover:text-white cursor-pointer dark:text-white"
              ...
              <li>
                <router-link to="/hra-calculator" 
                    ...
                    <span class="ml-[10px] text-sm">HRA Calculator</span>
                </router-link>
              </li>
              <li>
